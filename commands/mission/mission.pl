...
my @adverbs = (
    'appropriately',   'assertively',
    'authoritatively', 'collaboratively',
    'competently',     'completely',
    'continually',     'conveniently',
    'credibly',        'distinctively',
    'dramatically',    'dynamically',
    'efficiently',     'enthusiastically',
    'globally',        'holisticly',
    'interactively',   'intrinsicly',
    'objectively',     'proactively',
    'professionally',  'progressively',
    'quickly',         'seamlessly',
    'synergistically'
);
my @verbs = (
    'actualize',         'administrate',
    'build',             'communicate',
    ...
    'leverage other\'s', 'maintain',
    'negotiate',         'network',
    'parallel task',     'promote',
    'provide access to', 'pursue',
    're-engineer',       're-invent',
    'restore',           'revolutionize',
    'simplify',          'streamline',
    'supply',            'utilize'
);
my @adjectives = (
    'accurate',              'adaptive',
    'alternative',           'an expanded array of',
    'backward-compatible',   'best of breed',
    'business',              'client-based',
    'client-centered',       'client-centric',
    'client-focused',        'collaborative',
    'competitive',           'cooperative',
    'corporate',             'cost effective',
    'cross functional',      'cross-unit',
    'customer directed',     'cutting edge',
    'distinctive',           'diverse',
    'economically sound',    'effective',
    'emerging',              'empowered',
    'enabled',               'enterprise-wide',
    'equity invested',       'error-free',
    'ethical',               'excellent',
    'exceptional',           'flexible',
    'fully researched',      'fully tested',
    'functional',            'functionalized',
    'future-proof',          'global',
    'go forward',            'goal-oriented',
    'high standards in',     'high-payoff',
    'high-quality',          'highly efficient',
    'inexpensive',           'innovative',
    'installed base',        'integrated',
    'interactive',           'interdependent',
    'interoperable',         'just in time',
    'leading-edge',          'leveraged',
    'long-term high-impact', 'low-risk high-yield',
    'maintainable',          'market positioning',
    'market-driven',         'market-focused',
    'mission-critical',      'multidisciplinary',
    'multifunctional',       'multimedia based',
    'optimal',               'orthogonal',
    'parallel',              'performance based',
    'premier',               'premium',
    'principle-centered',    'proactive',
    'process-centric',       'professional',
    'progressive',           'prospective',
    'quality',               'reliable',
    'resource maximizing',   'resource-leveling',
    'scalable',              'stand-alone',
    'standards compliant',   'state of the art',
    'strategic',             'superior',
    'sustainable',           'tactical',
    'team building',         'team driven',
    'technically sound',     'timely',
    'top-line',              'turn-key',
    'unique',                'user friendly',
    'value-added',           'virtual',
    'world-class',           'worldwide',
    'prespecified',          'user-oriented'
);
my @nouns = (
